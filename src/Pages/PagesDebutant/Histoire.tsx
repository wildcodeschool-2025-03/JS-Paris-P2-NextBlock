                ...
                <main className="main-text">
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                d’années, le monde de la finance tremblait. <br />Les banques faisaient
                                faillite, les gens perdaient confiance, et une question planait
                                dans l’air : <br /><br />Et si on pouvait créer une monnaie sans banque ? Une
                                monnaie gérée par tout le monde… et par personne à la fois ? <br /><br />C’est
                    ...
                    <article className="article-text">
                        ...
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                attention : <br /><br />-Pas hébergée par une banque <br />-Pas imprimée par un
                                gouvernement <br />-Pas contrôlée par une entreprise <br />Non. Bitcoin
                                fonctionne grâce à un réseau de milliers d’ordinateurs dans le
                                monde, tous synchronisés par ce qu’on appelle une blockchain.<br />
                                Chaque transaction est enregistrée dans un bloc, qu’on ajoute à
                                une chaîne de blocs — transparente, infalsifiable, publique.<br /><br /> C’est
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                Au début, personne ne prenait Bitcoin au sérieux. <br />Mais un jour, en
                                2010, un développeur décide d’acheter deux pizzas pour 10 000 BTC.<br />
                                C’est la première vraie transaction, et ça restera dans
                                l’histoire. <br /><br />Aujourd’hui, ces pizzas vaudraient des millions. <br />Pas
                    ...
                    <article id="article-text">
                        <div id="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                si on pouvait faire plus que de simples paiements ? <br />C’est là
                                qu’est né Ethereum, en 2015.<br /> Son créateur, Vitalik Buterin,
                                voulait construire une plateforme intelligente, capable d'exécuter
                                automatiquement des contrats numériques (appelés smart contracts).<br /><br />
                                Avec Ethereum, les cryptomonnaies ne servaient plus juste à payer,
                                mais à créer : <br />-des applications décentralisées<br />-des jeux<br /> -des
                                œuvres numériques uniques (NFTs) <br />-et même de la finance sans
                                banque (DeFi)
                            </p>
                        </div>
                    ...
                    <article className="article-text">
                        ...
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                En 2021, les cryptos explosent.  <br />Tout le monde en parle : Bitcoin
                                dépasse 60 000 $, des stars lancent leurs NFT, des entreprises
                                investissent.  <br /> <br />Mais comme toute innovation jeune… il y a eu des
                                excès. Des projets douteux, des arnaques, des chutes
                                spectaculaires.  <br />En 2022, c’est l’hiver crypto : l’écosystème fait
                                le tri.
                            </p>
                        </div>
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                projets sérieux.  <br />Des développeurs passionnés.  <br />Et une communauté
                                mondiale qui croit à un internet plus libre, plus transparent,
                                plus décentralisé.  <br /> <br />Les cryptomonnaies, ce n’est pas juste de
                                l’argent. C’est une réinvention du système, une nouvelle manière
                                de penser la valeur, la confiance et l’échange. <br /> <br /> Et tu sais quoi ? <br />
                                L’histoire est loin d’être finie.  <br />Elle ne fait même que commencer. <br />

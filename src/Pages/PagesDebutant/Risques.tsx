                ...
                <main className="main-text">
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                en très peu de temps.<br /><br /> Un jour tu gagnes 30 %, le lendemain tu
                                perds 50 %.<br /><br /> Le marché peut être influencé par un tweet, une rumeur
                                ou une décision politique.<br /><br /> Ce n’est pas un terrain pour les gens
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                Ton argent est stocké dans un wallet (portefeuille numérique).<br />
                                Mais si tu perds ton mot de passe ou ta seed phrase (phrase de
                                récupération)… il est impossible de récupérer tes fonds. <br />Pas de
                                SAV, pas de « mot de passe oublié », pas de banque. <br /><br />Tu es le seul
                        ...
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                perdent leur valeur ou sont des escroqueries déguisées (rug pull).<br /><br />
                                Un projet peut sembler solide aujourd’hui, et s'effondrer demain.<br /><br />
                    ...
                    <article className="article-text">
                        ...
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                Le monde crypto attire aussi les escrocs :<br /><br /> -Faux projets qui
                                promettent des gains rapides. <br />-Sites de phishing qui volent tes
                                clés privées. <br />-Influenceurs douteux qui poussent à l’achat de
                                «shitcoins». <br /><br />Toujours vérifier, se renseigner, et ne jamais
                    ...
                    <article className="article-text">
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                ...
                                vite : <br /><br />-Certaines plateformes peuvent devenir illégales.<br /> -Des
                                impôts peuvent s’appliquer sans que tu le saches. <br />-Certains pays
                                interdisent purement l’usage des cryptos. <br />-Toujours se renseigner
                    ...
                    <article className="article-text">
                        ...
                        <div className="div-text">
                            ...
                            <p className="paragraphe-text">
                                Même les grandes plateformes (exchanges) peuvent :<br /><br /> -Être piratées.
                                <br />-Avoir des failles de sécurité. <br />-Bloquer temporairement l'accès à
                                tes fonds.<br />-Privilégier les plateformes fiables, et ne jamais tout

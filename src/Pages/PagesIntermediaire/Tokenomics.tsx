				...
				<main className="main-text">
					...
					<article className="article-text">
						<div>
							...
							<p className="paragraphe-text">
								...
								-Comment ils sont distribués (ex : à l’équipe, aux
								investisseurs, à la communauté…) -Leur utilité dans l’écosystème
								(paiement, gouvernance, récompense…) -Les mécanismes de contrôle
								comme le burn (destruction de tokens) ou staking (blocage en
								échange de récompenses) En bref, la tokenomics permet de
								comprendre comment un projet gère sa monnaie, et donc de savoir
								si son modèle est durable, juste et intéressant pour investir
							</p>
					...
					<article className="container">
						...
						<div>
							...
							<p className="paragraphe-text">
								Combien de tokens sont déjà en circulation sur le marché ? Si
								une grosse partie n’est pas encore libérée (vesting), cela peut
						...
						<div>
							...
							<p className="paragraphe-text">
								Regarde à qui vont les tokens : Équipe du projet (devs,
								fondateurs) Investisseurs privés Communauté Récompenses
								(staking, farming) Si l’équipe possède 60% des tokens et qu’ils
								ne sont pas bloqués dans le temps (vesting), ils peuvent tout
								vendre = gros risque de chute du prix.
							</p>
						</div>
						<div>
							<h2 className="h2-text">4- L’utilité du token (Use Case)</h2>
							<p className="paragraphe-text">
								Un bon token doit servir à quelque chose : Payer des frais (ex :
								BNB sur Binance) Staker pour valider des blocs (ex : ETH en
								Proof of Stake) Accéder à des services ou avantages (ex : tokens
								de gouvernance) Si le token n’a aucune utilité réelle, il n’a
								souvent aucune valeur durable.
							</p>
						</div>
					</article>
					<article className="article-text">
						<div>
							...
							<p className="paragraphe-text">
								...
								quadrillion Très large, peu claire Très spéculatif Ethereum Pas
								de limite fixe Staking, frais de réseau Infrastructure du Web3
					...
					<article className="article-text">
						<div>
							...
							<p className="paragraphe-text">
								...
								valeur d’une crypto Une phrase à retenir : Le marketing attire,
								mais la tokenomics révèle.
							</p>
							<div className="div-image" />
						</div>
					</article>

				...
				<main className="main-text">
					...
					<article className="article-text">
						<div className="div-text">
							...
							<p className="paragraphe-text">
								Qui sont les fondateurs ? Ont-ils de l’expérience ? Un
								historique vérifiable ? Y a-t-il des investisseurs connus ou
								partenariats solides ? Astuce : cherche les profils LinkedIn,
								interviews, ou entreprises partenaires réelles.
							</p>
						</div>
					</article>
					<article className="article-text">
						<div className="div-text">
							...
							<p className="paragraphe-text">
								Le whitepaper est un document technique qui présente : -le
								concept du projet, -sa technologie, -sa roadmap, -sa
								tokenomics.(voir page 3) Lis-le attentivement. Un whitepaper
								flou, trop marketing ou bourré de jargon inutile = drapeau
								rouge.
							</p>
						</div>
					</article>
					<article className="article-text">
						<div className="div-text">
							...
							<p className="paragraphe-text">
								Le projet est-il actif sur GitHub (si open source) ? Est-ce
								qu’il y a de la communication régulière (Twitter, Discord,
								Medium) ? Une communauté vivante, mais pas toxique, est souvent
								bon signe.
							</p>
						</div>
					</article>
					<article className="article-text">
						<div className="div-text">
							...
							<p className="paragraphe-text">
								On n’investit pas sans comprendre : -L’offre totale -Les
								allocations -L’utilité réelle -La politique de distribution Un
								projet peut être top sur le papier… mais mal géré économiquement
								= risque énorme.
							</p>
						</div>
					...
					<article className="article-text">
						<div className="div-text">
							...
							<p className="paragraphe-text">
								...
								dans tout ça ? L’analyse fondamentale classique vient du monde
								de la bourse. Mais en crypto, elle est encore plus importante,
								car : -les projets sont jeunes, -la régulation est faible, -et
								les arnaques existent. Un investisseur sérieux prend le temps de
